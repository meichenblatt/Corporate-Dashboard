...
gulp.task('concat', ['compress'], function() {
  return gulp.src(['./src/compressed/angular.min.js','./src/compressed/angular-route.min.js','./src/compressed/angular-resource.min.js','./src/compressed/jquery-3.1.1.min.js','./src/compressed/bootstrap.min.js','./src/compressed/app.js','./src/compressed/geospatial.js','./src/compressed/keymetrics.js','./src/compressed/dataview.js'])
    .pipe(concat('all.js'))
